...
# -*- coding: utf-8 -*-
#
# lAppUpdate documentation build configuration file, created by
# sphinx-quickstart on Sun Mar  6 15:59:09 2016.
#
...
sys.path.insert(0, os.path.abspath("./appdownload"))
...
exclude_patterns = ["_delivery"]

# The reST default role (used for this markup: `text`) to use for all
# documents. To avoid any ambiguity, each reStructuredText source files
# specify the default domain and the default role.
# default_role = "any"
...
htmlhelp_basename = "lAppUpdatedoc"
...
man_pages = [
    (master_doc, "lappupdate", "lAppUpdate Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "lAppUpdate", "lAppUpdate Documentation",
     author, "lAppUpdate", "One line description of project.",
     "Miscellaneous"),
]
